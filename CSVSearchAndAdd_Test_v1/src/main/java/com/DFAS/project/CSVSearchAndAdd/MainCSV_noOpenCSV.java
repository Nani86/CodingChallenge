...
public class MainCSV_noOpenCSV {
	...
	private static final String CSV_FILE_PATH = "C:\\Users\\NaniG\\eclipse-workspace\\CSVSearchAndAdd_Test_v1\\files\\persons.csv";
...
//						break;
				...
				System.out.print("Error:the entered data is not valid. Please make sure it is all numbers."
			     ...
			     inputPerson.setAddress(scanner.nextLine());
			     System.out.print("Enter City: ");
			     inputPerson.setCity(scanner.nextLine());
			     System.out.print("Enter State: ");
			     inputPerson.setState(scanner.nextLine());
...
//						updatedPersons.add(existingPerson);
			            int v = PersonService.equalscheck(existingPerson, inputPerson); 
